...
export const LEADERS: Leader[] = [
  {
    ...
    description:
      'Our CEO, Peter, credits his hardworking East Asian immigrant parents who undertook the ' +
      'arduous journey to the shores of America with the intention of giving their children the best future.' +
  ...
  },
  {
    ...
    // tslint:disable-next-line:max-line-length
    description:
      'Our CFO, Danny, as he is affectionately referred to by his colleagues, ' +
  ...
  },
  {
    ...
    description:
      ...
      'You click only if you survive my lick.',
  },
  {
    id: '3',
    ...
    // tslint:disable-next-line:max-line-length
    description:
      'Award winning three-star Michelin chef with wide International experience having worked ' +
      'closely with whos-who in the culinary world, he specializes in creating mouthwatering Indo-Italian fusion experiences.' +
